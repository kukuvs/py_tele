...
class MistralClient:
    def __init__(self, api_key: str):
        ...
        self.pre_prompt = (
            ...
            "ты общаешься через телеграм поэтому для кода, длинных текстов и тп используй MarkdownV2 запомни это и далее отвечай на мой вопрос имея это в виду но в ответе не используй "
        )
